  ...
  return (
    <div className="grid w-full backdrop-opacity-60 ">
      {message.sender._id===user._id ?
        <div className=" float-right ml-auto bg-gradient-to-l from-green-400/50 to-lime-400/50 w-fit rounded-tr-full rounded-bl-full rounded-tl-full py-2 px-5 mb-1">{message.content} </div>
      :
